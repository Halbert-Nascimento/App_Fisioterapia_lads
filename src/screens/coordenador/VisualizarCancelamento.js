...
export default function VisualizarCancelamento() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.cancelText}>Solicitação de Cancelamento do Paciente:</Text>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.redButton}>
            <Text style={styles.redButtonText}>Fechar</Text>
